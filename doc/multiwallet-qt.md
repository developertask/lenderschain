...
In order to support loading of multiple wallets in lenderschain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lenderschain.cpp.
...
Changes to lenderschain.cpp
----------------------
lenderschain.cpp is the entry point into lenderschain-qt, and as such, will require some minor modifications to provide hooks for
