...
* WebSocket: [https://github.com/lenderschain/insight-api-lenderschain#web-socket-api](https://github.com/lenderschain/insight-api-lenderschain#web-socket-api)
* API: [https://github.com/lenderschain/insight-api-lenderschain#swifttx-transactions](https://github.com/lenderschain/insight-api-lenderschain#swifttx-transactions)
...
By default, the Lenderschain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lenderschain Core daemon:
