...
Intro
-----
Lenderschain (LNC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Lenderschain utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run lenderschain-qt.exe.

Lenderschain Core is the original Lenderschain client and it builds the backbone of the network.
However, it downloads and stores the entire history of Lenderschain transactions;
