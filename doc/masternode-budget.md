...
Lenderschain now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<lenderschain_address\> \<monthly_payment_lenderschain\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ LNC, _12_ times over the course of a year totaling _24000_ LNC.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<lenderschain_address\> \<monthly_payment_lenderschain\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` LNC.
 ...
 * vote-many          - Vote on a Lenderschain initiative
 * vote-alias         - Vote on a Lenderschain initiative
 * vote               - Vote on a Lenderschain initiative/budget
