...
lenderschain/lenderschain repository.
...
Setup
---------
Configuring the github-merge tool for the Lenderschain repository is done in the following way:

    git config githubmerge.repository lenderschain/lenderschain
...
A script to optimize png files in the Lenderschain
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_lenderschain: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_lenderschain: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_lenderschain: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_lenderschain: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
