Contributing to Lenderschain Core
==================================

The Lenderschain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Lenderschain Core project, and is not to be
confused with overall Lenderschain Network Protocol consensus changes.

Whether a pull request is merged into Lenderschain Core rests with the project merge
...
Patches that change Lenderschain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Lenderschain consensus, it must have been
...
The project leader is the release manager for each Lenderschain Core release.
