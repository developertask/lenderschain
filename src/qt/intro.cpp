...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Lenderschain Core"),
     ...
     * override -datadir in the lenderschain.conf file in the default data directory
     * (to be consistent with lenderschaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
