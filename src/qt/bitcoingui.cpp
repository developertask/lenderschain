                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Lenderschain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LNC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lenderschain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lenderschain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lenderschain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lenderschain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LNC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LNC addresses"));
    ...
    openAction->setStatusTip(tr("Open a lenderschain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lenderschain Core help message to get a list with possible Lenderschain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Lenderschain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lenderschain network", "", count));
}
...
{
    QString strTitle = tr("Lenderschain Core"); // default title
