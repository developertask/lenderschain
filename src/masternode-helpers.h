...
// Copyright (c) 2017-2018 The Lenderschain developers
...
public:
    ...
    /// Is the inputs associated with this public key? (and there is LNC collateral - checking if valid masternode)
