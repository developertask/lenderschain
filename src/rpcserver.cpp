...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Lenderschain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Lenderschain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lenderschain features */
        {"lenderschain", "masternode", &masternode, true, true, false},
        {"lenderschain", "listmasternodes", &listmasternodes, true, true, false},
        {"lenderschain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lenderschain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lenderschain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lenderschain", "masternodedebug", &masternodedebug, true, true, false},
        {"lenderschain", "startmasternode", &startmasternode, true, true, false},
        {"lenderschain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lenderschain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lenderschain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lenderschain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lenderschain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lenderschain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lenderschain", "mnbudget", &mnbudget, true, true, false},
        {"lenderschain", "preparebudget", &preparebudget, true, true, false},
        {"lenderschain", "submitbudget", &submitbudget, true, true, false},
        {"lenderschain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lenderschain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lenderschain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lenderschain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lenderschain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lenderschain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lenderschain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lenderschain", "checkbudgets", &checkbudgets, true, true, false},
        {"lenderschain", "mnsync", &mnsync, true, true, false},
        {"lenderschain", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> lenderschain-cli " + methodname + " " + args + "\n";
}
