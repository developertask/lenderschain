...
#if defined(NDEBUG)
#error "Lenderschain cannot be compiled without assertions."
#endif
...
{
    RenameThread("lenderschain-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // LNC: We use certain sporks during IBD, so check to see if they are
