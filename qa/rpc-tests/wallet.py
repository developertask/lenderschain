...
#   c) node1 mines 32 blocks, so now node 0 has 500000LNC, node 1 has 4250LNC, node2 has none.
#   d) node0 sends 601 LNC to node2, in two transactions (301 LNC, then 300 LNC).
